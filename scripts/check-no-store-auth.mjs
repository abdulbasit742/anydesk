...
const checks = {
  ...
  setsNoCacheAndMustRevalidate: noStoreSource.includes("no-cache") && noStoreSource.includes("must-revalidate"),
  setsProxyRevalidateAndPrivate: noStoreSource.includes("proxy-revalidate") && noStoreSource.includes("private"),
  setsMaxAgeZero: noStoreSource.includes("max-age=0"),
