...
const checks = {
  ...
  connectRequestWrapped: /bindSafeSocketHandler<.*ConnectRequestPayload.*>\(socket,\s*ClientEvents\.ConnectRequest/i.test(socketSource),
  connectResponseWrapped: /bindSafeSocketHandler<.*SessionResponsePayload.*>\(socket,\s*ClientEvents\.ConnectResponse/i.test(socketSource),
