...
const checks = {
  ...
  serverAppliesRequestTimeout: serverSource.includes("server.requestTimeout = HTTP_REQUEST_TIMEOUT_MS"),
  serverAppliesHeadersTimeout: serverSource.includes("server.headersTimeout = HTTP_HEADERS_TIMEOUT_MS"),
  serverAppliesKeepAliveTimeout: serverSource.includes("server.keepAliveTimeout = HTTP_KEEP_ALIVE_TIMEOUT_MS"),
  serverAppliesLegacyTimeout: serverSource.includes("server.timeout = HTTP_REQUEST_TIMEOUT_MS"),
