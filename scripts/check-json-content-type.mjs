...
const checks = {
  ...
  charsetGuardImportsSharedTypesAndMethods: charsetGuardSource.includes('import { JSON_BODY_METHODS, JSON_BODY_TYPES } from "./requireJsonContentType.js"'),
  ...
  charsetGuardLimitsToJsonBody: charsetGuardSource.includes("isJsonContentType") && charsetGuardSource.includes("hasRequestBody") && charsetGuardSource.includes("JSON_BODY_METHODS.has(req.method)"),
