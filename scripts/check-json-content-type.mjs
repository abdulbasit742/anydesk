...
const checks = {
  ...
  rejectsUnsupportedEncoding: encodingGuardSource.includes("unsupported_content_encoding") && encodingGuardSource.includes("message: UNSUPPORTED_CONTENT_ENCODING_MESSAGE"),
  ...
  rejectsUnsupportedCharset: charsetGuardSource.includes("unsupported_charset") && charsetGuardSource.includes("message: UNSUPPORTED_JSON_CHARSET_MESSAGE"),
