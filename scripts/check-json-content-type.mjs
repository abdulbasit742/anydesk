...
const checks = {
  ...
  acceptsJsonFromSharedTypes: middlewareSource.includes("JSON_BODY_TYPES.some") && middlewareSource.includes("req.is(type)"),
  ...
  charsetGuardImportsSharedRequestScope: charsetGuardSource.includes('import { JSON_BODY_METHODS, JSON_BODY_TYPES, hasRequestBody, isApiPath } from "./requireJsonContentType.js"'),
  ...
  charsetGuardLimitsToJsonBody: charsetGuardSource.includes("isJsonContentType") && charsetGuardSource.includes("hasRequestBody(req)") && charsetGuardSource.includes("JSON_BODY_METHODS.has(req.method)") && charsetGuardSource.includes("isApiPath(req.path)"),
  charsetGuardUsesSharedJsonTypes: charsetGuardSource.includes("JSON_BODY_TYPES.some") && charsetGuardSource.includes('type === "application/*+json"') && charsetGuardSource.includes("mediaType.endsWith"),
