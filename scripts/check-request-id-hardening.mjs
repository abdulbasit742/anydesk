...
const checks = {
  ...
  serverDefinesAllowedCorsMethods: serverSource.includes("ALLOWED_CORS_METHODS") && serverSource.includes('"GET"') && serverSource.includes('"POST"') && serverSource.includes('"DELETE"') && serverSource.includes('"OPTIONS"'),
