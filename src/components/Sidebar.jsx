...
const INITIAL_NAV_ITEMS = [
  ...
  { section: 'Build', items: [
    ...
    { id: 'emailstudio', label: 'Email Studio' },
    { id: 'aivideostudio', label: 'AI Video Studio' },
  ]},
  { section: 'Prompts', items: [
    { id: 'promptqueue',   label: 'Prompt Queue' },
    { id: 'library',       label: 'Prompt Library' },
    { id: 'promptbuilder', label: 'Prompt Builder' },
    { id: 'optimizer',     label: 'AI Optimizer' },
    { id: 'autopromptengine', label: 'Auto-Prompt' },
    { id: 'history',       label: 'History' },
    { id: 'scratchpad',    label: 'Journal Notes' },
  ]},
  { section: 'System', items: [
    { id: 'featuremarketplace', label: 'Marketplace' },
  ...
  { section: 'Categories', items: [
    { id: 'agentworkflows',  label: 'Agent Workflows' },
    { id: 'apiintegrations', label: 'API Integrations' },
    { id: 'devutilities',    label: 'Dev Utilities' },
    { id: 'dataanalytics',   label: 'Data Analytics' },
    { id: 'uiextensions',    label: 'UI Extensions' },
    { id: 'securityguards',  label: 'Security Guards' },
  ]},
  { section: 'Power Tools', items: [
    { id: 'aichat',              label: 'AI Chat' },
    { id: 'deploymentcenter',    label: 'Deploy Center' },
    { id: 'codeeditor',          label: 'Code Editor' },
    { id: 'performanceprofiler', label: 'Profiler' },
    { id: 'collaborationhub',    label: 'Collab Hub' },
    { id: 'commandcenter',       label: 'Command Center' },
    { id: 'voicecommander',      label: 'Voice Commander' },
    { id: 'multiagentorchestrator', label: 'Agent Orchestrator' },
  ]},
  { section: 'Intelligence', items: [
    { id: 'aiinsights',          label: 'AI Insights' },
    { id: 'marketintelligence',  label: 'Market Intel' },
    { id: 'modelbenchmarks',     label: 'Model Benchmarks' },
  ]},
  { section: 'AI & Data', items: [
    ...
    { id: 'usagequotas',  label: 'Usage & Quotas' },
    { id: 'promptmarketplace', label: 'Prompt Market' },
    { id: 'webscraper',   label: 'Web Scraper' },
    { id: 'containermanager', label: 'Containers' },
    { id: 'loadbalancer', label: 'Load Balancer' },
    { id: 'dbmanager', label: 'Db Manager' },
    { id: 'loganalyzer', label: 'Log Analyzer' },
    { id: 'observabilityhub', label: 'Observability Hub' },
  ]},
  { section: 'SaaS Layer', items: [
    { id: 'landing', label: 'Landing Page' },
    { id: 'pricing', label: 'Pricing Plans' },
    { id: 'signup', label: 'Create Account' },
    { id: 'login', label: 'Access Portal' },
...
const MASTER_PAGES_LIST = [
  ...
  { id: 'projects',        label: 'Projects Workspace', emoji: '📁' },
  { id: 'workflows',       label: 'Workflows & Pipeline', emoji: '⚙️' },
  { id: 'scheduler',       label: 'Cron Scheduler', emoji: '⏱️' },
  ...
  { id: 'templates',       label: 'Gallery Templates', emoji: '📌' },
  { id: 'comparison',      label: 'Response Comparison', emoji: '↔️' },
  { id: 'sandbox',         label: 'AI Sandbox', emoji: '🧪' },
  { id: 'history',         label: 'Broadcast History', emoji: '🕓' },
  { id: 'responseinbox',   label: 'Response Inbox', emoji: '📥' },
  { id: 'reports',         label: 'Export Reports', emoji: '📊' },
  { id: 'notifications',   label: 'Alert Notifications', emoji: '🔔' },
  { id: 'integrations',    label: 'API Integrations', emoji: '🔗' },
  { id: 'teamhub',         label: 'Team Hub', emoji: '👥' },
  { id: 'knowledgebase',   label: 'Knowledge Base', emoji: '📖' },
  { id: 'changelog',       label: 'Platform Changelog', emoji: '📝' },
  ...
  { id: 'featuremarketplace', label: 'Extensions Marketplace', emoji: '🛒' },
  { id: 'agentworkflows',  label: 'Agent Workflows', emoji: '⚙️' },
  { id: 'apiintegrations', label: 'API Integrations', emoji: '🔗' },
  { id: 'devutilities',    label: 'Developer Utilities', emoji: '🛠️' },
  ...
  { id: 'aichat',          label: 'AI Chat Interface', emoji: '💬' },
  { id: 'deploymentcenter', label: 'Deployment Center', emoji: '🚀' },
  { id: 'codeeditor',      label: 'Code Editor', emoji: '📝' },
  { id: 'performanceprofiler', label: 'Performance Profiler', emoji: '⚡' },
  { id: 'collaborationhub', label: 'Collaboration Hub', emoji: '👥' },
  { id: 'commandcenter',   label: 'Command Center', emoji: '📡' },
  { id: 'autopromptengine', label: 'Auto-Prompt Engine', emoji: '🎯' },
  { id: 'aiinsights',      label: 'AI Insights Engine', emoji: '💡' },
  { id: 'marketintelligence', label: 'Market Intelligence', emoji: '📈' },
  { id: 'modelbenchmarks',  label: 'Model Benchmarks', emoji: '🏆' },
  { id: 'aitraining',     label: 'AI Training Studio',   emoji: '🧠' },
  { id: 'datapipeline',   label: 'Data Pipeline Builder', emoji: '🔀' },
  { id: 'networkmap',     label: 'Network Topology Map',  emoji: '🌐' },
  { id: 'smartalerts',    label: 'Smart Alert Center',    emoji: '🔔' },
  { id: 'usagequotas',    label: 'Usage & Quotas',        emoji: '📊' },
  { id: 'promptmarketplace', label: 'Prompt Marketplace', emoji: '🏪' },
  { id: 'webscraper',     label: 'Web Scraper Parser',    emoji: '🕸️' },
  { id: 'containermanager', label: 'Container Orchestrator', emoji: '📦' },
  { id: 'loadbalancer',   label: 'Gateway Load Balancer', emoji: '⚖️' },
  { id: 'dbmanager',      label: 'Database Schema Manager', emoji: '🗄️' },
  { id: 'loganalyzer',    label: 'Log Analyzer',          emoji: '📺' },
  { id: 'emailstudio',             label: 'Email Studio Campaign', emoji: '📧' },
  { id: 'learningcenter',          label: 'Learning Center Tutorial', emoji: '🎓' },
  { id: 'observabilityhub',        label: 'Observability & Tracing', emoji: '🔭' },
  { id: 'voicecommander',          label: 'Voice Commander Vocal', emoji: '🎙️' },
  { id: 'multiagentorchestrator',  label: 'Multi-Agent Orchestrator', emoji: '🕹️' },
  { id: 'cryptowallet',            label: 'Crypto Wallet Manager', emoji: '👛' },
  { id: 'aivideostudio',           label: 'AI Video Studio Suite', emoji: '🎥' },
  { id: 'systemstatus',   label: 'System Status Dashboard', emoji: '🌡️' },
  { id: 'settings',       label: 'System Settings',       emoji: '⚙️' },
];
          ...
          <>
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 2, minWidth: 0 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                ...
                <a 
                  href="https://status.agentflow.sh" 
                  target="_blank" 
